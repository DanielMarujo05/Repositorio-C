...
int main() {
    ...
    for(i = 1; i <= 100; i++) {
        printf("%d,", i); // Imprime o valor atual de i seguido de uma vírgula
        // Loop para percorrer de 1 a 100 em incrementos de 1
        for(j = 1; j <= 100; j++) {
            // Verifica se o valor de j é igual ao valor de i
            if(j == i) {
                printf("%d,", j*100); // Imprime o valor correspondente de j multiplicado por 100 seguido de uma vírgula
